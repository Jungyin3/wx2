...
class Wechat {
   ...
   savaAccessToken (access_token) {
        ...
        return new Promise((resolve,reject) => {
            writeFile('./day1/06_JS-SDK/utils/access_token.txt',access_token,err => {
                if(!err){
                    console.log('文件保存成功~');
                    resolve();
                }else{
   ...
   readAccessToken () {
    ...
    //读取本地的jsapi_ticket
    return new Promise((resolve,reject) => {
        readFile('./day1/06_JS-SDK/utils/access_token.txt',(err,data) => {
            if(!err){
                console.log('文件读取成功~');
                //将JSON字符串转换为对象
   ...
   savaTicket (ticket) {
        ...
        //将access-token保存成一个文件
        return new Promise((resolve,reject) => {
            writeFile('./day1/06_JS-SDK/utils/ticket.txt',ticket,err => {
                if(!err){
                    console.log('文件保存成功~');
                    resolve();
                }else{
   ...
   readTicket () {
    ...
    //读取本地的jsapi_ticket
    return new Promise((resolve,reject) => {
        readFile('./day1/06_JS-SDK/utils/ticket.txt',(err,data) => {
            if(!err){
                console.log('文件读取成功~');
                //将JSON字符串转换为对象
                data = JSON.parse(data);
